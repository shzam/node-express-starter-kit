...
enum StatusCode {
  ...
  abstract class ApiResponse{
    constructor (protected statusCode:StatusCode,protected message:string,protected status?:ResponseStatus){}
    ...
    protected prepare<T extends ApiResponse>(
        ...
        return res.status(this.status as number).json(ApiResponse.sanitize(response));
      }
  ...
  export class InternalErrorResponse extends ApiResponse {
    constructor(message = 'Internal Error') {
      super(StatusCode.FAILURE,  message,ResponseStatus.INTERNAL_SERVER_ERROR);
    }
  }
